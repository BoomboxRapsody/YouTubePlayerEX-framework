...
{
    public abstract partial class RoundedScrollContainer<T> : Container<T>, IScrollContainer, DelayedLoadWrapper.IOnScreenOptimisingContainer, IKeyBindingHandler<PlatformAction>
        where T : Drawable
    {
        /// <summary>
        ...
        protected RoundedScrollContainer(Direction scrollDirection = Direction.Vertical)
        {
